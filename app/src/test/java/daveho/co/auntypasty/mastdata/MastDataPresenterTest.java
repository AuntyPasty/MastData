...
public class MastDataPresenterTest {
    ...
    @Mock
    private MastListView mockMastListView;
    ...
    public void setup() throws Exception {
        ...
        sut = new MastDataPresenter(mContext, mockMastListView, mockRentalsView, mockTenantsView);
    ...
    public void getListShouldReturnListOfObjects() {
        sut.getListFromDataFile(testData);

        verify(mockMastListView).showTop5MastList(anyList());
    }
}
